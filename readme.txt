...
Torre.c é il modulo che viene eseguito dal primo figlio generato da Aeroporto.c e si occupa di gestire le richieste provenienti dagli aerei. Contiene due funzioni utili al suo funzionamento: receive_mex che permette di leggere un messaggio dalla pipe e get_runway per gestire l'array delle piste.
